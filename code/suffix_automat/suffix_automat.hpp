...
private:
    ...
    public:
        ...
        Index next(Symbol to) const { return is_way(to) ? next_.find(to)->second : 0; }
...
public:
    ...
    public:
        ...
        void set_position(Index pos) { position_ = pos < owner_.data_.size() ? pos : 0; }
...
public:
    ...
    Suffix_automat(const Cont &src) : state_(*this, 0) { insert(src); }
...
public:
    ...
    template <typename Cont>
    void insert(const Cont &src) { insert(src.begin(), src.end()); }
